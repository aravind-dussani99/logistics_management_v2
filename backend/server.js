  ...
  try {
    const trip = await prisma.tripRecord.create({
      data: {
        ...
        gstRatePerTon: Number(data.gstRatePerTon || 0),
  ...
  try {
    ...
    const trip = await prisma.tripRecord.update({
      ...
      data: {
        ...
        gstRatePerTon: sanitizedData.gstRatePerTon !== undefined ? Number(sanitizedData.gstRatePerTon) : undefined,
        gstPercentage: sanitizedData.gstPercentage !== undefined ? Number(sanitizedData.gstPercentage) : undefined,
        gstAmount: sanitizedData.gstAmount !== undefined ? Number(sanitizedData.gstAmount) : undefined,
      },
    });
