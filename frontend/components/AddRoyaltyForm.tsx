...
import { RoyaltyOwner, RateEntry } from '../types';
import { safeToFixed } from '../utils';

interface AddRoyaltyFormProps {
    onClose: () => void;
}
...
const AddRoyaltyForm: React.FC<AddRoyaltyFormProps> = ({ onClose }) => {
    ...
    useEffect(() => {
        const baseRate = rateData.ratePerM3 || 0;
    ...
    }, [rateData.ratePerM3, rateData.gst, rateData.gstPercentage]);
    ...
    return (
        <form onSubmit={handleSubmit} className="p-8">
            <div className="space-y-10">
                <div>
                    <h3 className="text-xl font-semibold leading-6 text-gray-900 dark:text-white">1. Royalty Owner Details</h3>
